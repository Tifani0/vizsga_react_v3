...
export default function ServicesBeauty() {
  ...
  useEffect(() => {
    fetch("http://localhost:3000/beauticians")
      .then((r) => r.json())
  ...
  return (
    <>
      <div className="page-header">
        <h1>Kozmetikai szolgáltatások</h1>
        <p className="page-subtitle">Válassz kozmetikust és foglalj időpontot!</p>
      </div>
          ...
          <div className="professional-card" key={prof.id}>
            <div className="professional-card-header">
              ...
              <div>
                ...
                <span className="professional-type-badge kozmetikus">Kozmetikus</span>
              </div>
            </div>
              ...
              {prof.services?.map((service) => (
                <div className="service-item" key={service.id}>
                  ...
                  <button className="btn-book-service"
                    onClick={() => setBookingTarget({ professional: { ...prof, type: "Kozmetikus" }, service })}>
                    Foglalás
                  </button>
                </div>
              ))}
